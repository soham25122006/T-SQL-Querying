...
SELECT POWER(5,2),SQUARE(15),POWER(25,2)
...
SELECT SIN(301415),COS(301415),TAN(301415)
...
SELECT LOWER('soham'),UPPER('SOHAM')
--3. Display first three characters of your name.
SELECT SUBSTRING('SOHAM',1,3)
--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('SOMU VBAETHETBHTB',3,7)
...
SELECT SPACE(10) + 'SOHAM'
--14. Combine two strings using + sign as well as CONCAT ().
SELECT 'SOHAM' + ' RATHOD' , CONCAT('SOHAM',' RATHOD')
--15. Find reverse of “Darshan”.
SELECT REVERSE('DARSHAN')
--16. Repeat your name 3 times.
SELECT REPLICATE('REPLICATE',3)
...
SELECT SUBSTRING(FIRSTNAME,2,LEN(FIRSTNAME)-1) FROM EMPLOYEE
...
SELECT FIRSTNAME,REVERSE(FIRSTNAME) AS REVERSE_NAME FROM EMPLOYEE
